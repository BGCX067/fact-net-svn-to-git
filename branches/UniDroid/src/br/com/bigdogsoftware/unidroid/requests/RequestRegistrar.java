 ...
 * 
 */
public class RequestRegistrar extends Request {
	
	private String matricula;
	private String senha;
	
	public RequestRegistrar(String matricula, String senha) {
		super();
	...
	public void run() {
	    ...
	    nameValuePairs.add(new BasicNameValuePair("acao", "realizarCadastro"));
